...
func main() {
	...
	defaultPort, portErr := strconv.Atoi(os.Getenv("PORT"))
	if portErr != nil {
		defaultPort = 4000
	}
	...
	//LATER: handle 404s https://stackoverflow.com/questions/62747416/handling-custom-404-pages-with-http-fileserver
